...
-- 2. Ottieni l'ID dell'utente admin
-- (Questo sarà eseguito automaticamente)

-- 3. Inserisci categorie principali
...
-- 7. Inserisci sottocategorie per Salute
INSERT INTO subcategories (name, main_category_id) 
SELECT 'Medico', mc.id 
FROM main_categories mc 
JOIN users u ON mc.user_id = u.id 
...
-- 8. Inserisci sottocategorie per Svago
INSERT INTO subcategories (name, main_category_id) 
SELECT 'Cinema', mc.id 
FROM main_categories mc 
JOIN users u ON mc.user_id = u.id 
...
-- 9. Inserisci sottocategorie per Altro
INSERT INTO subcategories (name, main_category_id) 
